...
export default function Module6Grade812Page() {
  ...
  const projects = [
    {
      ...
      objective: 'Master file operations including reading, writing, and managing data files in Python',
      learningOutcomes: [
        'Opening and closing files properly',
        'Reading and writing file content',
        'Working with different file formats'
      ],
      image: 'https://static.wixstatic.com/media/39909b_ca9c66d3c472440fa77b03d7d1bce7e0~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 2,
      title: 'Python Classes & Objects',
      objective: 'Learn object-oriented programming by creating and using classes and objects',
      learningOutcomes: [
        'Defining classes and creating objects',
        'Understanding attributes and methods',
        'Implementing constructors and destructors'
      ],
      image: 'https://static.wixstatic.com/media/39909b_2ebd7b43ea7e45f2a52124c553d8db0a~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 3,
      title: 'Modules & Packages',
      objective: 'Organize code into reusable modules and packages for better project structure',
      learningOutcomes: [
        'Creating and importing modules',
        'Understanding package structure',
        'Using built-in and third-party packages'
      ],
      image: 'https://static.wixstatic.com/media/39909b_8b93e72e72c247cf9e7a6de94f5a34ee~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 4,
      title: 'Inheritance & Polymorphism',
      objective: 'Master advanced OOP concepts for code reuse and flexibility',
      learningOutcomes: [
        'Creating parent and child classes',
        'Implementing method overriding',
        'Understanding polymorphic behavior'
      ],
      image: 'https://static.wixstatic.com/media/39909b_ccebc186c1b345cebceaed06f27b64eb~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 5,
      title: 'Encapsulation & Abstraction',
      objective: 'Learn to hide implementation details and protect data in your classes',
      learningOutcomes: [
        'Using private and public access modifiers',
        'Creating abstract classes and interfaces',
        'Implementing data protection mechanisms'
      ],
      image: 'https://static.wixstatic.com/media/39909b_d366e6afbaf840f081b1bb25f418c18c~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 6,
      title: 'Bank Account Management System',
      objective: 'Build a complete banking system using OOP principles',
      learningOutcomes: [
        'Creating account classes with balance tracking',
        'Implementing deposit and withdrawal operations',
        'Managing transaction history and security'
      ],
      image: 'https://static.wixstatic.com/media/39909b_563d395c684941ef87ca293023cafe59~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 7,
      title: 'Online Shopping System',
      objective: 'Develop a complete e-commerce platform with product and cart management',
      learningOutcomes: [
        'Creating product and shopping cart classes',
        'Implementing checkout and payment processing',
        'Managing inventory and order tracking'
      ],
      image: 'https://static.wixstatic.com/media/39909b_6b7af6dee45940b697bf995271801a16~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 8,
      title: 'Student Information System',
      objective: 'Create a comprehensive student management system for educational institutions',
      learningOutcomes: [
        'Managing student records and grades',
        'Implementing course enrollment and scheduling',
        'Generating academic reports and transcripts'
      ],
      image: 'https://static.wixstatic.com/media/39909b_2ce1227ea1794651961aaa2fdf038370~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 9,
      title: 'Online Quiz Application',
      objective: 'Build an interactive quiz platform with scoring and analytics',
      learningOutcomes: [
        'Creating quiz questions and answer management',
        'Implementing scoring algorithms',
        'Tracking user progress and performance analytics'
      ],
      image: 'https://static.wixstatic.com/media/39909b_8b787e929ba742418334cf2b7dfcb035~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 10,
      title: 'Discord Bot',
      objective: 'Create an automated Discord bot with command handling and event responses',
      learningOutcomes: [
        'Using Discord API and libraries',
        'Implementing bot commands and responses',
        'Managing events and user interactions'
      ],
      image: 'https://static.wixstatic.com/media/39909b_57a7217fe6b8484396366901bc896bc3~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 11,
      title: 'Age Calculator using Tkinter',
      objective: 'Build a desktop GUI application for calculating age with Tkinter',
      learningOutcomes: [
        'Creating GUI windows and widgets',
        'Handling user input from text fields',
        'Implementing date calculations and formatting output'
      ],
      image: 'https://static.wixstatic.com/media/39909b_b747d921e1f14107ad3915248fb4cda8~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 12,
      title: 'Registration Form using Tkinter',
      objective: 'Develop a complete registration form with validation and data storage',
      learningOutcomes: [
        'Creating form layouts with multiple widgets',
        'Implementing input validation',
        'Saving form data to files or databases'
      ],
      image: 'https://static.wixstatic.com/media/39909b_b5d8d0e2ff3d43c1adecfc4a517b33d0~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 13,
      title: 'Countdown Timer using Tkinter',
      objective: 'Create an interactive countdown timer application with controls',
      learningOutcomes: [
        'Implementing timer logic and time management',
        'Creating control buttons for start, pause, and reset',
        'Displaying real-time countdown updates'
      ],
      image: 'https://static.wixstatic.com/media/39909b_c4b2fc3aec424dcabc6ce38283c1e5d0~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 14,
      title: 'QR Code Generator using Python',
      objective: 'Build a QR code generation tool with customization options',
      learningOutcomes: [
        'Using QR code libraries and APIs',
        'Generating QR codes from text and URLs',
        'Customizing QR code appearance and saving to files'
      ],
      image: 'https://static.wixstatic.com/media/39909b_0f5851aaa330400197fb1148e63449c9~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 15,
      title: 'ChatBot using ChatGPT API',
      objective: 'Create an intelligent chatbot powered by ChatGPT for conversational AI',
      learningOutcomes: [
        'Integrating ChatGPT API in Python applications',
        'Handling conversation flows and context',
        'Building interactive chat interfaces'
      ],
      image: 'https://static.wixstatic.com/media/39909b_a63aca7275bd40a6be20b839d4ce187b~mv2.png?originWidth=448&originHeight=384'
    }
  ];
  ...
  const keyFeatures = [
    {
      ...
      description: 'Master object-oriented programming, file handling, and advanced Python concepts to build professional-grade applications'
    },
    {
      icon: Cpu,
      title: 'Real-World Application Development',
      description: 'Build practical applications including banking systems, e-commerce platforms, and automation tools that solve real problems'
    },
    {
      icon: Code,
      title: 'GUI & API Integration',
      description: 'Learn to create desktop applications with Tkinter and integrate with external APIs like ChatGPT and Discord'
    }
  ];
      ...
      <section className="relative pt-20 pb-28 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Python Automation for Kids introduces young learners to the fundamentals of automating everyday tasks using simple Python scripts. Through engaging projects, kids explore how to use Python libraries to enhance their programs with additional features. As they progress, they are introduced to more advanced concepts such as web scraping, email automation, and creating social media posts—empowering them to solve real-world problems with code.
            </motion.p>
                  ...
                  {[
                    {
                      ...
                      desc: 'Master classes, objects, inheritance, polymorphism, and encapsulation to build professional-grade applications'
                    },
                    {
                      title: 'File & Data Management',
                      desc: 'Learn to read, write, and manipulate files, working with various data formats and storage systems'
                    },
                    {
                      title: 'GUI Development',
                      desc: 'Create desktop applications with Tkinter, building interactive user interfaces with forms and controls'
                    },
                    {
                      title: 'API Integration & Automation',
                      desc: 'Integrate external APIs like ChatGPT and Discord, automate tasks, and build intelligent applications'
                    }
                  ].map((item, idx) => (
                    <motion.div 
                      key={idx} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-foreground/70 max-w-3xl mx-auto">
              Each project teaches advanced Python concepts through real-world applications and professional development practices
            </p>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative p-14 md:p-20 rounded-3xl border border-secondary/40 bg-gradient-to-br from-secondary/10 via-background to-background backdrop-blur-sm">
              ...
              >
                Join learners mastering advanced Python with 15 real-world projects that teach professional development practices, automation, and API integration.
              </motion.p>
