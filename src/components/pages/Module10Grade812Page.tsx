...
export default function Module10Grade812Page() {
  ...
  const projects = [
    {
      number: 1,
      title: 'Introduction to HTML Tags and Elements',
      objective: 'Understanding HTML syntax and structure to build the foundation of web pages',
      learningOutcomes: [
        'Understanding HTML syntax and structure',
        'Ability to use basic HTML tags to create a webpage',
        'Creating semantic and well-formed HTML documents'
      ],
      image: 'https://static.wixstatic.com/media/39909b_477924d569a046f3af835152a26428d9~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 2,
      title: 'Document Structure and Text Formatting',
      objective: 'Learn HTML documents and various text formatting options for content presentation',
      learningOutcomes: [
        'Creating well-structured HTML documents',
        'Applying text formatting (bold, italic, underline)',
        'Using heading hierarchy correctly'
      ],
      image: 'https://static.wixstatic.com/media/39909b_e291ce6e15b54a4d888300d90a3a4536~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 3,
      title: 'Links and Images',
      objective: 'Explore hyperlinking and image embedding capabilities in HTML',
      learningOutcomes: [
        'Creating clickable links and navigation',
        'Embedding images and understanding image attributes',
        'Using alt text for accessibility'
      ],
      image: 'https://static.wixstatic.com/media/39909b_8c7452a4e09d4e5e81ef1ffc7b1685fc~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 4,
      title: 'Lists and Tables',
      objective: 'Introduce HTML lists and tables for content organization and data representation',
      learningOutcomes: [
        'Creating ordered and unordered lists',
        'Constructing tables for data representation',
        'Organizing content with proper structure'
      ],
      image: 'https://static.wixstatic.com/media/39909b_255848ac1a254cb3830e99483f7f3025~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 5,
      title: 'HTML Forms',
      objective: 'Teach the creation of interactive forms using HTML for user input',
      learningOutcomes: [
        'Implementing HTML forms and form elements',
        'Understanding form attributes and input types',
        'Creating user-friendly form interfaces'
      ],
      image: 'https://static.wixstatic.com/media/39909b_5ad67dc12e4345809471e792a58a49ad~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 6,
      title: 'Multimedia Elements',
      objective: 'Explore embedding multimedia content like audio and video in web pages',
      learningOutcomes: [
        'Embedding audio and video elements',
        'Configuring multimedia attributes and controls',
        'Optimizing media for web delivery'
      ],
      image: 'https://static.wixstatic.com/media/39909b_84c4fe941e4e44008c38d0c1f0486e1c~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 7,
      title: 'Semantic HTML',
      objective: 'Introduce semantic HTML for improved document structure and accessibility',
      learningOutcomes: [
        'Understanding semantic tags and their purpose',
        'Applying semantic HTML for accessibility',
        'Improving SEO with proper semantic markup'
      ],
      image: 'https://static.wixstatic.com/media/39909b_3d2f3ebc3eaa44a5a47ade1f3d5e3e42~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 8,
      title: 'Canvas & SVG',
      objective: 'Explore the HTML canvas and SVG for graphics and visualizations',
      learningOutcomes: [
        'Creating drawings and graphics using HTML canvas',
        'Understanding SVG for vector graphics',
        'Building interactive visual elements'
      ],
      image: 'https://static.wixstatic.com/media/39909b_f689f55a01b3446aafaa0471eca37292~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 9,
      title: 'Responsive Web Design',
      objective: 'Teach principles of responsive web design for various devices and screen sizes',
      learningOutcomes: [
        'Implementing media queries for responsive design',
        'Creating responsive layouts and flexible grids',
        'Optimizing for mobile, tablet, and desktop'
      ],
      image: 'https://static.wixstatic.com/media/39909b_042f66cd314241658c30fcd64b1a881e~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 10,
      title: 'Personal Portfolio Page',
      objective: 'Apply HTML skills to create a personal portfolio webpage showcasing your work',
      learningOutcomes: [
        'Designing and building a personal portfolio',
        'Showcasing skills and projects effectively',
        'Creating a professional online presence'
      ],
      image: 'https://static.wixstatic.com/media/39909b_6d47b07474ad407aa06f1819df6f376e~mv2.png?originWidth=448&originHeight=384'
    }
  ];

  const stats = [
    { label: '18 Classes', icon: BookOpen, color: 'from-orange-500/20 to-orange-600/10' },
    { label: '15 Projects', icon: Code, color: 'from-amber-500/20 to-amber-600/10' },
    { label: '22 Concepts', icon: Lightbulb, color: 'from-yellow-500/20 to-yellow-600/10' }
  ];
  ...
  const keyFeatures = [
    {
      ...
      description: 'Master HTML from basic tags to semantic markup with comprehensive coverage of all HTML5 elements and best practices'
    },
    {
      icon: Cpu,
      title: 'Web Page Creation',
      description: 'Build well-structured, accessible web pages using proper HTML syntax and semantic elements for better SEO and usability'
    },
    {
      icon: Code,
      title: 'Professional Web Development',
      description: 'Learn industry-standard practices including responsive design, accessibility, and modern HTML5 features for professional websites'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="inline-block mb-8">
              ...
              >
                ...
                <motion.div
                  ...
                  transition={{ duration: 1.2, repeat: Infinity }}
                />
                <span className="font-heading text-sm font-bold text-secondary tracking-wide relative z-10">BEGINNER LEVEL • GRADES 8-12</span>
              </motion.div>
            </div>
            ...
            >
              ...
              >
                <GradientText>HTML</GradientText>
              </motion.span>
            </motion.h1>
            ...
            >
              Master HTML fundamentals to build the foundation of web development. Learn HTML structure, tags, and attributes to create well-formed web pages. Explore semantic HTML, forms, multimedia, and responsive design principles to create professional, accessible websites.
            </motion.p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {[
                    {
                      title: 'HTML Structure & Syntax',
                      desc: 'Master HTML tags, elements, and document structure for building well-formed web pages'
                    },
                    {
                      title: 'Content Organization',
                      desc: 'Learn to organize content with lists, tables, and semantic HTML for better structure'
                    },
                    {
                      title: 'Interactive Elements',
                      desc: 'Create forms, multimedia content, and interactive elements for engaging user experiences'
                    },
                    {
                      title: 'Responsive & Accessible Design',
                      desc: 'Build responsive websites that work on all devices and follow accessibility best practices'
                    }
                  ].map((item, idx) => (
                    <motion.div 
                      key={idx} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-foreground/70 max-w-3xl mx-auto">
              Each project builds on previous concepts, advancing from basic HTML tags to building complete, responsive web pages
            </p>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative p-14 md:p-20 rounded-3xl border border-secondary/40 bg-gradient-to-br from-secondary/10 via-background to-background backdrop-blur-sm">
              ...
              >
                Join learners mastering HTML with 10 engaging projects that build professional web development skills and create responsive, accessible, and well-structured web pages.
              </motion.p>
