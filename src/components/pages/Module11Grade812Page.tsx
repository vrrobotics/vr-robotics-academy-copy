...
export default function Module11Grade812Page() {
  ...
  const projects = [
    {
      ...
      objective: 'Introduce the basics of CSS syntax and rules for styling HTML elements effectively',
      learningOutcomes: [
        'Understanding CSS syntax and rule structure',
        'Applying styles to HTML elements',
        'CSS comments and best practices'
      ],
      image: 'https://static.wixstatic.com/media/39909b_dbe83dd6e82b41ce96da926156ca558e~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 2,
      title: 'Selectors and Declarations',
      objective: 'Explore CSS selectors to target HTML elements for styling with precision and control',
      learningOutcomes: [
        'Use of CSS selectors (element, class, ID)',
        'Applying various style declarations',
        'Selector specificity and cascading'
      ],
      image: 'https://static.wixstatic.com/media/39909b_9426aaf6905e49d88cd0c6d13f546e49~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 3,
      title: 'Margin, Padding, Border and Box Sizing',
      objective: 'Teach CSS box model and its properties for controlling element spacing and sizing',
      learningOutcomes: [
        'Understanding the CSS box model',
        'Margin and padding properties',
        'Border properties and box-sizing'
      ],
      image: 'https://static.wixstatic.com/media/39909b_60b2d6f818da4336826ca384e711873e~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 4,
      title: 'CSS Text Styling and Fonts',
      objective: 'Cover text styling options and font properties for beautiful typography',
      learningOutcomes: [
        'Applying styles to text elements',
        'Working with different font styles and weights',
        'Text alignment, decoration, and effects'
      ],
      image: 'https://static.wixstatic.com/media/39909b_b5d8d42529e3407684cfd2e6009cb804~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 5,
      title: 'Layout, Floating and Positioning in CSS',
      objective: 'Explore CSS layout and positioning techniques for page structure and design',
      learningOutcomes: [
        'Creating responsive layouts',
        'Implementing floating and positioning',
        'Display properties and layout control'
      ],
      image: 'https://static.wixstatic.com/media/39909b_24da02f10d6b49ec8484ca2bd294ae9f~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 6,
      title: 'Navigation Bar, Dropdowns and Image Gallery',
      objective: 'Develop a navigation bar, drop-down menus and image galleries using CSS',
      learningOutcomes: [
        'Creating styled navigation bars',
        'Implementing drop-down menus',
        'Building image galleries with CSS'
      ],
      image: 'https://static.wixstatic.com/media/39909b_a9adbc6ff1804b1e9054e1b95f55587b~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 7,
      title: 'CSS3: Transitions and Animations',
      objective: 'Introduce Transitions and Animations for webpage interactivity and engagement',
      learningOutcomes: [
        'Implementing smooth transitions',
        'Creating animations using CSS3 keyframes',
        'Timing functions and animation properties'
      ],
      image: 'https://static.wixstatic.com/media/39909b_b29f6ddabfb141c583452e686f1a2418~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 8,
      title: 'Shadows and Filters',
      objective: 'Use CSS3 shadows and filters for depth and visual effects on elements',
      learningOutcomes: [
        'Implementing shadows for depth',
        'Various CSS filters for visual effects',
        'Combining shadows and filters creatively'
      ],
      image: 'https://static.wixstatic.com/media/39909b_802999d9e88f4e15becf73cbbd61fbbe~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 9,
      title: '2D, 3D, Translate, Rotate, Scale Effects',
      objective: 'Explore 2D and 3D transformations, rotate, and scale effects for dynamic designs',
      learningOutcomes: [
        'Applying 2D and 3D transformations',
        'Scale effects using CSS3',
        'Perspective and 3D transforms'
      ],
      image: 'https://static.wixstatic.com/media/39909b_061d6215e91d45d68a3656b45858578e~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 10,
      title: 'Animated Image Slider and Hover Effects',
      objective: 'Develop an animated image slider and hover effects using CSS for engagement',
      learningOutcomes: [
        'Creating dynamic image sliders',
        'Implementing engaging hover effects',
        'Advanced CSS animation techniques'
      ],
      image: 'https://static.wixstatic.com/media/39909b_6fb0f7c753fc4da5b32cf3ce603854fd~mv2.png?originWidth=448&originHeight=384'
    }
  ];

  const stats = [
    { label: '20 Classes', icon: BookOpen, color: 'from-orange-500/20 to-orange-600/10' },
  ...
  const keyFeatures = [
    {
      ...
      description: 'Master CSS from fundamentals to advanced techniques with comprehensive coverage of all CSS3 features'
    },
    {
      icon: Cpu,
      title: 'Interactive Web Design',
      description: 'Create vibrant, interactive web pages with transitions, animations, and dynamic effects that engage users'
    },
    {
      icon: Code,
      title: 'Responsive & Flexible Layouts',
      description: 'Build responsive designs using modern layout techniques like Flexbox and Grid for all devices'
    }
  ];
      ...
      <section className="relative pt-20 pb-28 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Master CSS to enhance web pages with vibrant styles and structured layouts. Learn transitions and animations to add interactive, dynamic elements. Explore Flexbox and Grid for advanced layouts and responsive designs across all devices.
            </motion.p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {[
                    {
                      title: 'CSS Fundamentals & Syntax',
                      desc: 'Master CSS basics including selectors, declarations, and the cascade for effective styling'
                    },
                    {
                      title: 'Advanced Styling Techniques',
                      desc: 'Learn text styling, fonts, colors, and visual effects for beautiful web pages'
                    },
                    {
                      title: 'Modern Layout Systems',
                      desc: 'Build responsive layouts with Flexbox, Grid, and positioning for all devices'
                    },
                    {
                      title: 'Interactive Animations',
                      desc: 'Create engaging transitions, animations, and interactive effects that captivate users'
                    }
                  ].map((item, idx) => (
                    <motion.div 
                      key={idx} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-foreground/70 max-w-3xl mx-auto">
              Each project builds on previous concepts, advancing from basic CSS syntax to sophisticated, interactive web designs
            </p>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative p-14 md:p-20 rounded-3xl border border-secondary/40 bg-gradient-to-br from-secondary/10 via-background to-background backdrop-blur-sm">
              ...
              >
                Ready to Master Web Development CSS?
              </motion.h2>
              ...
              >
                Join learners mastering CSS with 10 engaging projects that build professional web design skills and create vibrant, interactive, responsive websites.
              </motion.p>
