...
export default function Module7DetailsPage() {
  ...
  const projects = [
    {
      ...
      image: 'https://static.wixstatic.com/media/39909b_c609ff07ddb44fbb9a65254ada60c9ee~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 2,
      ...
      image: 'https://static.wixstatic.com/media/39909b_46c1ed10f6dc43eba4af3a7f7425348b~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 3,
      title: 'Smart Dustbin',
      ...
      image: 'https://static.wixstatic.com/media/39909b_0daa50b18ad5498d8002f45c86844398~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 4,
      ...
      image: 'https://static.wixstatic.com/media/39909b_8259ecfb362d4f06b5d907d52fc23087~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 5,
      ...
      image: 'https://static.wixstatic.com/media/39909b_5c89fe77513a4dfe99c86099b6dd8f6d~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 6,
      ...
      image: 'https://static.wixstatic.com/media/39909b_468df9804733404c84f6a7768a978494~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 7,
      ...
      image: 'https://static.wixstatic.com/media/39909b_ae079bb8f5e243a1a1b80d1b6ef17a91~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 8,
      ...
      image: 'https://static.wixstatic.com/media/39909b_55e0906de32b47e492679e88a1b5d9ab~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 9,
      ...
      image: 'https://static.wixstatic.com/media/39909b_099075689bc54b22b4d94e81fc2436e1~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 10,
      ...
      image: 'https://static.wixstatic.com/media/39909b_8223ce375620420aafd3efd8f8a33cfb~mv2.png?originWidth=448&originHeight=384'
    }
  ];
  ...
  const keyFeatures = [
    {
      ...
      description: 'Learn practical electronics through real-world projects using Raspberry Pi and various sensors'
    },
    {
      icon: Cpu,
      title: 'IoT & Automation',
      description: 'Explore Internet of Things concepts and build smart, automated systems that solve real problems'
    },
    {
      icon: Code,
      title: 'Problem-Solving Skills',
      description: 'Develop critical thinking by tackling real-world challenges and creating innovative solutions'
    }
  ];
      ...
      <section className="relative pt-20 pb-28 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Raspberry Pi Projects for Kids spark curiosity and creativity by introducing fun and interactive activities. Children learn how to communicate with computers, explore basic electronics, and create exciting projects like weather prediction and message displays. Using Raspberry Pi, kids develop problem-solving skills while working on real-world challenges and building cool creations together.
            </motion.p>
                  ...
                  {[
                    {
                      ...
                      desc: 'Learn the basics of Raspberry Pi, GPIO pins, and how to interface with various sensors and components'
                    },
                    {
                      title: 'Electronics & Circuits',
                      desc: 'Understand circuit design, component integration, and how to build functional electronic systems'
                    },
                    {
                      title: 'IoT & Smart Systems',
                      desc: 'Create connected devices and smart automation systems that solve real-world problems'
                    },
                    {
                      title: 'Problem-Solving Approach',
                      desc: 'Develop critical thinking by designing, building, and troubleshooting real hardware projects'
                    }
                  ].map((item, idx) => (
                    <motion.div 
                      key={idx} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-foreground/70 max-w-3xl mx-auto">
              Build real-world IoT and robotics projects that combine electronics, programming, and creative problem-solving
            </p>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative p-14 md:p-20 rounded-3xl border border-primary/40 bg-gradient-to-br from-primary/10 via-background to-background backdrop-blur-sm">
              ...
              >
                Join young innovators mastering Raspberry Pi through hands-on projects that combine electronics, programming, and creative problem-solving.
              </motion.p>
