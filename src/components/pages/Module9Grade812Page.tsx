...
export default function Module9Grade812Page() {
  ...
  const projects = [
    {
      ...
      objective: 'Create a home automation system for remote control of appliances',
      learningOutcomes: [
        'IoT integration',
        'Sensor control',
      ...
      image: 'https://static.wixstatic.com/media/39909b_8233f842972b4596affab5ee0b1829c4~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 2,
      title: 'Getting started with SenseHAT',
      objective: 'Familiarize with SenseHAT and its functionalities',
      learningOutcomes: [
        'Basic sensor interactions',
        'Programming on SenseHAT'
      ],
      image: 'https://static.wixstatic.com/media/39909b_7d80cc9337254f68b1e6c5b846424cff~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 3,
      title: 'Countdown Timer',
      objective: 'Build a versatile countdown timer using SenseHAT',
      learningOutcomes: [
        'Timer functionality',
        'Event-driven programming',
        'Adaptable timer design'
      ],
      image: 'https://static.wixstatic.com/media/39909b_67e462f290d640aabb47d13ef45c800c~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 4,
      title: 'Rainbow Predictor',
      objective: 'Develop a program predicting and displaying rainbow',
      learningOutcomes: [
        'Color representation',
        'Basic prediction algorithms',
        'Integration of external data'
      ],
      image: 'https://static.wixstatic.com/media/39909b_b4745e49c68b4ff6805faf1f9f90c351~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 5,
      title: 'Virtual Dice Roller',
      objective: 'Create a dynamic virtual dice rolling app with SenseHAT',
      learningOutcomes: [
        'Advanced random number generation',
        'Dynamic dice simulation',
        'User-configurable options'
      ],
      image: 'https://static.wixstatic.com/media/39909b_5b9c66ee7abb4b7faa23f0c263db537f~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 6,
      title: 'SenseHAT Pong',
      objective: 'Implement the classic Pong game using SenseHAT',
      learningOutcomes: [
        'Advanced game development',
        'Multiplayer functionality',
        'User interface enhancements'
      ],
      image: 'https://static.wixstatic.com/media/39909b_b6f5e3ce49444533ab2ad7b6ab65667a~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 7,
      title: 'Finding North with compass sensor',
      objective: 'Use compass sensor to determine North with accuracy',
      learningOutcomes: [
        'Compass sensor integration',
        'Navigation',
        'Precision enhancement'
      ],
      image: 'https://static.wixstatic.com/media/39909b_bc3cb06f2ff4402797cfdb0d04301959~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 8,
      title: 'Where\'s the Treasure?',
      objective: 'Develop a treasure hunt game',
      learningOutcomes: [
        'Game design',
        'Algorithmic complexity',
        'User engagement strategies'
      ],
      image: 'https://static.wixstatic.com/media/39909b_38be0f32161e432d93aa46de06ffcf54~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 9,
      title: 'Flappy Astronaut',
      objective: 'Create a Flappy Bird game with an astronaut using HAT',
      learningOutcomes: [
        'Game physics',
        'Character animation',
        'Power-up implementation'
      ],
      image: 'https://static.wixstatic.com/media/39909b_eb9af10c588247599822396ac2ed988a~mv2.png?originWidth=448&originHeight=384'
    },
    {
      number: 10,
      title: 'SenseHAT Marble maze',
      objective: 'Build an immersive marble maze game using SenseHAT',
      learningOutcomes: [
        'Advanced game physics',
        'Tilt sensor integration',
        'Dynamic maze generation'
      ],
      image: 'https://static.wixstatic.com/media/39909b_bf0258f179fd426dae578a11b2c7bbde~mv2.png?originWidth=448&originHeight=384'
    }
  ];

  const stats = [
    { label: '23 Classes', icon: BookOpen, color: 'from-secondary/20 to-secondary/10' },
    { label: '15 Projects', icon: Code, color: 'from-primary/20 to-primary/10' },
    { label: '25 Concepts', icon: Lightbulb, color: 'from-secondary/20 to-secondary/10' }
  ];
  ...
  const keyFeatures = [
    {
      ...
      description: 'Master Python and Raspberry Pi to build sophisticated robotic systems with real-world applications'
    },
    {
      icon: Cpu,
      title: 'Hardware-Software Integration',
      description: 'Learn to seamlessly integrate hardware components with software control for intelligent automation'
    },
    {
      icon: Code,
      title: 'AI & Machine Learning',
      description: 'Implement machine learning models on edge devices for intelligent decision-making and automation'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              >
                <GradientText>Inventor</GradientText>
              </motion.span>
            </motion.h1>
            ...
            >
              Master advanced robotics with Raspberry Pi and Python. Build intelligent systems that combine hardware control, computer vision, and machine learning to create real-world solutions.
            </motion.p>
                  ...
                  {[
                    {
                      ...
                      desc: 'Learn advanced Raspberry Pi programming and hardware integration for sophisticated robotics applications'
                    },
                    {
                      title: 'Python for Robotics',
                      desc: 'Master Python programming specifically designed for robotics control, automation, and AI integration'
                    },
                    {
                      title: 'Computer Vision & AI',
                      desc: 'Implement machine learning and computer vision algorithms on edge devices for intelligent decision-making'
                    },
                    {
                      title: 'Real-World Projects',
                      desc: 'Build practical robotics systems that combine hardware, software, and AI for real-world applications'
                    }
                  ].map((item, idx) => (
                    <motion.div 
                      key={idx} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-foreground/70 max-w-3xl mx-auto">
              Each project builds on previous concepts, advancing from fundamental robotics to sophisticated AI-powered systems
            </p>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative p-14 md:p-20 rounded-3xl border border-secondary/40 bg-gradient-to-br from-secondary/10 via-background to-background backdrop-blur-sm">
              ...
              >
                Join advanced learners building intelligent robotics systems with Raspberry Pi, Python, and AI through 10 comprehensive projects that teach real-world integration techniques.
              </motion.p>
