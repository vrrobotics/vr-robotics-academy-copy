...
export default function PiRoboticsTinkererPage() {
  ...
  const keyFeatures = [
    {
      icon: Rocket,
      title: 'Hands-On Hardware Projects',
      description: 'Learn electronics and programming through practical projects that bring ideas to life with real hardware components'
    },
    {
      icon: Cpu,
      title: 'IoT and Smart Systems',
      description: 'Build intelligent systems that interact with the physical world, from smart homes to autonomous robots'
    },
    {
      icon: Code,
      title: 'Real-World Problem Solving',
      description: 'Develop solutions to everyday challenges while mastering electronics, coding, and engineering principles'
    }
  ];
                  ...
                  {[
                    {
                      ...
                      desc: 'Learn circuit design, component integration, and electrical principles through hands-on hardware projects'
                    },
                    {
                      title: 'IoT Development',
                      desc: 'Master Internet of Things concepts by building connected devices that communicate and share data'
                    },
                    {
                      title: 'Robotics and Automation',
                      desc: 'Design and build autonomous systems that sense their environment and respond intelligently'
                    },
                    {
                      title: 'Real-World Engineering',
                      desc: 'Apply engineering principles to solve practical problems and create functional prototypes'
                    }
                  ].map((item, idx) => (
                    <motion.div 
                      key={idx} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-foreground/70 max-w-3xl mx-auto">
              Each project builds on previous concepts, advancing from basic electronics to sophisticated IoT systems
            </p>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative p-14 md:p-20 rounded-3xl border border-secondary/40 bg-gradient-to-br from-secondary/10 via-background to-background backdrop-blur-sm">
              ...
              >
                Ready to Become a Pi Robotics Tinkerer?
              </motion.h2>
              ...
              >
                Join learners building amazing IoT projects with Raspberry Pi, mastering electronics, coding, and robotics through 10 engaging hands-on projects.
              </motion.p>
