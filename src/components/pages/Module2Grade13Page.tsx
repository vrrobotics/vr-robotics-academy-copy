...
export default function Module2Grade13Page() {
  ...
  const projects = [
    {
      ...
      image: 'https://static.wixstatic.com/media/39909b_2fe481db44224075973eb52af4c39cf1~mv2.png?id=module2-g13-project1'
    },
    {
      number: 2,
      title: 'Design a Logo',
      ...
      image: 'https://static.wixstatic.com/media/39909b_5e43359d0c1b45e9a7337c8d77086216~mv2.png?id=module2-g13-project2'
    },
    {
      number: 3,
      ...
      image: 'https://static.wixstatic.com/media/39909b_f55dc5acdaf549bf8b7ca2ec353fc6e1~mv2.png?id=module2-g13-project3'
    },
    {
      number: 4,
      ...
      image: 'https://static.wixstatic.com/media/39909b_5d483af039684a64b279729437a90554~mv2.png?id=module2-g13-project4'
    },
    {
      number: 5,
      ...
      image: 'https://static.wixstatic.com/media/39909b_61c9eb1b51bf49efb6d49be2d557b2fa~mv2.png?id=module2-g13-project5'
    },
    {
      number: 6,
      ...
      image: 'https://static.wixstatic.com/media/39909b_830652508ad8454ca5b7413d164bdd02~mv2.png?id=module2-g13-project6'
    },
    {
      number: 7,
      ...
      image: 'https://static.wixstatic.com/media/39909b_c6b535b781d74852b546f89a46c2e981~mv2.png?id=module2-g13-project7'
    },
    {
      number: 8,
      ...
      image: 'https://static.wixstatic.com/media/39909b_ecacbc40aa1b4e0eb1515b38a9d1d29c~mv2.png?id=module2-g13-project8'
    },
    {
      number: 9,
      ...
      image: 'https://static.wixstatic.com/media/39909b_70b734f8e6db4535ab7e919e52ff9cf5~mv2.png?id=module2-g13-project9'
    },
    {
      number: 10,
      ...
      image: 'https://static.wixstatic.com/media/39909b_9d37b32c37054422b211e5774b8c525e~mv2.png?id=module2-g13-project10'
    }
  ];
  ...
  const stats = [
    ...
    { label: '20 Concepts', icon: Lightbulb, color: 'from-yellow-500/20 to-yellow-600/10' }
  ];

  const keyFeatures = [
    {
      icon: Rocket,
      title: 'Intuitive 3D Modeling',
      description: 'Learn 3D design fundamentals through drag-and-drop interface with visual feedback'
    },
    {
      icon: Cpu,
      title: 'Creative Problem Solving',
      description: 'Develop spatial reasoning and design thinking through real-world project challenges'
    },
    {
      icon: Code,
      title: 'Digital Fabrication Skills',
      description: 'Master design principles applicable to 3D printing and digital manufacturing'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              >
                <GradientText>3D Design</GradientText>
              </motion.span>
            </motion.h1>
            ...
            >
              Unlock your creativity with intuitive 3D modeling. Design everything from keychains to rockets and bring your imagination to life through digital fabrication.
            </motion.p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {[
                    {
                      title: '3D Spatial Thinking',
                      desc: 'Develop visualization skills by understanding how 2D shapes combine to create 3D objects'
                    },
                    {
                      title: 'Design Fundamentals',
                      desc: 'Learn core design principles including shape manipulation, scaling, and spatial relationships'
                    },
                    {
                      title: 'Creative Expression',
                      desc: 'Transform ideas into digital models through intuitive drag-and-drop 3D modeling tools'
                    },
                    {
                      title: 'Digital Fabrication',
                      desc: 'Understand how digital designs translate to real-world objects through 3D printing and manufacturing'
                    }
                  ].map((item, idx) => (
                    <motion.div 
                      key={idx} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-foreground/70 max-w-3xl mx-auto">
              Each project builds your 3D design skills, from simple shapes to complex architectural models
            </p>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative p-14 md:p-20 rounded-3xl border border-secondary/40 bg-gradient-to-br from-secondary/10 via-background to-background backdrop-blur-sm">
              ...
              >
                Join young designers mastering TinkerCad with 10 engaging 3D design projects that build real creative and technical skills.
              </motion.p>
